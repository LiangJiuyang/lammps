...
TEST_F(KSpaceAutoSlabTest, PPPMUsesPaperFormulaWithManualGewald)
{
  ...
  EXPECT_NEAR(lmp->force->kspace->slab_volfactor, expected_volfactor(1.0e-6, 0.3), 1.0e-12);
}
